...
showCoinValue(event.clienX, event.clienY, clickValue)
})

buyUpgrade.addEventListener('click', (event) => {
if(score >= upgradeCost) {
    ...
    result.innerText = `Вы купили улучшение, теперь у вас за каждый клик ${clickValue}🐵`
} else {
